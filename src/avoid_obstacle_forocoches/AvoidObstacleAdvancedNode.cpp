...
#include "avoid_obstacle_forocoches/AvoidObstacleAdvancedNode.hpp"
  ...
  AvoidObstacleAdvancedNode::AvoidObstacleAdvancedNode()
    : Node("avoid_obstacle_advanced_node")
  {
     // Setting parameters
    ...
    subscriber_ = create_subscription<sensor_msgs::msg::LaserScan>(
        "input_scan",10,
        std::bind(&AvoidObstacleAdvancedNode::subscription_callback, this, std::placeholders::_1));
    // Building Publisher
    publisher_ = create_publisher<geometry_msgs::msg::Twist>("output_vel",10);
    timer_ = create_wall_timer(
        20ms, std::bind(&AvoidObstacleAdvancedNode::timer_callback, this));
    ...
    timerRadar_ = create_wall_timer(
        20ms, std::bind(&AvoidObstacleAdvancedNode::timer_callback_radar, this));
  }

  void AvoidObstacleAdvancedNode::subscription_callback(const sensor_msgs::msg::LaserScan::SharedPtr msg)
  {
    auto scan = msg.get();
  ...
  void AvoidObstacleAdvancedNode::timer_callback_radar(){
  ...
  void AvoidObstacleAdvancedNode::timer_callback()
  {
  ...
  std::vector<bool> AvoidObstacleAdvancedNode::sectorize(std::vector<float>& data, float sectors, float range){
  ...
  bool AvoidObstacleAdvancedNode::obstacleAnalize(std::vector<bool>& status, int sensivity){
  ...
  AvoidObstacleAdvancedNode::Direction AvoidObstacleAdvancedNode::calculate_side_to_avoid_obstacle(std::vector<bool>& status){
  ...
  void AvoidObstacleAdvancedNode::setIntensities(std::vector<bool>& frontal,std::vector<bool>& avoid,std::vector<bool>& danger){
  ...
  std::vector<float> AvoidObstacleAdvancedNode::translate_kobuki_scan(std::vector<float> ranges){
