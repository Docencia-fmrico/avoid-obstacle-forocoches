...
void AvoidObstacleAdvancedNode::subscription_callback(
...
std::vector<bool> AvoidObstacleAdvancedNode::sectorize(
  std::vector<float> & data, float sectors,
  float range)
{
...
AvoidObstacleAdvancedNode::Direction AvoidObstacleAdvancedNode::calculate_side_to_avoid_obstacle(
...
void AvoidObstacleAdvancedNode::setIntensities(
  std::vector<bool> & frontal,
